	...
	var Animation = function (Glide, Core) {
      ...
      */
		Module.prototype.carousel = function () {
			...
			if (Glide.options.centered) shift = Core.Clones.shift - Glide.paddings;else
      ...
      */
		Module.prototype.append = function () {
			...
			for (var i in this.items) {
				...
				if (pattern[i] >= 0) item.appendTo(Glide.track);else
   ...
   */
	...
	var Helper = function (Glide, Core) {
		...
		Module.prototype.byAxis = function (hValue, vValue) {
			if (Glide.axis === 'y') return vValue;else
			return hValue;
		};
      ...
      */
		Module.prototype.start = function (event) {
			...
			if (!Core.Events.disabled && !this.dragging) {
				...
				// Cache event
				if (event.type === 'mousedown') touch = event.originalEvent;else
      ...
      */
		Module.prototype.move = function (event) {
			...
			if (!Core.Events.disabled && this.dragging) {
				...
				// Cache event
				if (event.type === 'mousemove') touch = event.originalEvent;else
				touch = event.originalEvent.touches[0] || event.originalEvent.changedTouches[0];
      ...
      */
		Module.prototype.end = function (event) {
			...
			if (!Core.Events.disabled && this.dragging) {
				...
				// Cache event
				if (event.type === 'mouseup' || event.type === 'mouseleave') touch = event.originalEvent;else
				touch = event.originalEvent.touches[0] || event.originalEvent.changedTouches[0];
   ...
   */
     ...
     */
		Module.prototype.get = function (property) {
			...
			if (!this.jumping) return property + ' ' + Glide.options.animationDuration + 'ms ' + Glide.options.animationTimingFunc;else
   ...
   */
	...
	Glide.prototype.getPaddings = function () {
		...
		if (typeof option === 'string') {
			...
			if (isPercentage) return parseInt(this.slider[this.size]() * (normalized / 100));else
			return normalized;
...
;(function () {
	...
	function widthChanged(mq) {
		if (mq.matches) slider.glide($.extend(options, { paddings: '18%' }));else
